...
*/
namespace Nisl\Bannerslider\Block\Adminhtml\Banner\Edit\Tab;

use Nisl\Bannerslider\Model\Status;
...
class Banner extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
     ...
     *
     * @var \Nisl\Bannerslider\Model\ResourceModel\Value\CollectionFactory
     */
     ...
     * slider factory.
     *
     * @var \Nisl\Bannerslider\Model\SliderFactory
     */
    protected $_sliderFactory;

    /**
     * @var \Nisl\Bannerslider\Model\Banner
     */
    protected $_banner;
     ...
     * @param \Nisl\Bannerslider\Model\Banner                           $banner
     * @param \Nisl\Bannerslider\Model\ResourceModel\Value\CollectionFactory $valueCollectionFactory
     * @param \Nisl\Bannerslider\Model\SliderFactory                    $sliderFactory
     * @param array                                                          $data
     */
    public function __construct(
        ...
        \Nisl\Bannerslider\Model\Banner $banner,
        \Nisl\Bannerslider\Model\ResourceModel\Value\CollectionFactory $valueCollectionFactory,
        \Nisl\Bannerslider\Model\SliderFactory $sliderFactory,
    ...
    protected function _prepareLayout()
    {
        ...
        \Magento\Framework\Data\Form::setFieldsetElementRenderer(
            $this->getLayout()->createBlock(
                'Nisl\Bannerslider\Block\Adminhtml\Form\Renderer\Fieldset\Element',
...
//            $datetime = new \DateTime($dataObj->getData('end_time'));
        ...
        $elements['target'] = $fieldset->addField(
            ...
            [
                ...
                'values' => [
                    [
                        'value' => \Nisl\Bannerslider\Model\Banner::BANNER_TARGET_SELF,
                        'label' => __('New Window with Browser Navigation'),
                    ],
                    [
                        'value' => \Nisl\Bannerslider\Model\Banner::BANNER_TARGET_PARENT,
                        'label' => __('Parent Window with Browser Navigation'),
                    ],
                    [
                        'value' => \Nisl\Bannerslider\Model\Banner::BANNER_TARGET_BLANK,
